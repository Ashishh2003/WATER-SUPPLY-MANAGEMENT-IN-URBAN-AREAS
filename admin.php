...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = $conn->prepare("SELECT password FROM admin WHERE department = ?");
    ...
    if ($result && password_verify($password, $result["password"])) {
        ...
        $_SESSION["admin"] = $department;
        header("Location: " . $department . "_admin.php");
        exit();
    } else {
        echo "<script>alert('Invalid department or password!'); window.location.href='admin.php';</script>";
    }
...
<head>
    ...
    <title>Admin Login - HydroCity Solutions</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="#">Admin Login</a></li>
                ...
                <form id="adminLoginForm" method="POST" action="admin_dashboard.php">
                    <div class="mb-4">
                        ...
                        <select class="form-select" id="department" name="department" required>
                            <option value="drainage">Drainage Admin</option>
                            <option value="sewerage">Sewerage Admin</option>
                            <option value="illegal">Illegal Connection Admin</option>
                            <option value="water">New Water Connection Admin</option>
                            <option value="meter">Meter Fixation Admin</option>
