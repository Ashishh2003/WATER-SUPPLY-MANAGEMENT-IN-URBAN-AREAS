...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (move_uploaded_file($imageTmpName, $imagePath)) {
        ...
        $sql = $conn->prepare("INSERT INTO sewerage (landmark, image_path) VALUES (?, ?)");
        $sql->bind_param("ss", $landmark, $imagePath);
...
<head>
    ...
    <title>Sewerage Complaint - HydroCity Solutions</title>
    ...
    <section class="complaint-section">
        <div class="container">
            <div class="complaint-card">
                <h2 class="complaint-title">Report Sewerage Issue</h2>
                <form action="sewerage.php" method="POST" enctype="multipart/form-data">
                    <div class="mb-4">
                        <label for="image" class="form-label">Upload Image of the Sewerage Issue</label>
                    ...
                    <div class="mb-4">
                        <label for="landmark" class="form-label">Landmark or Location Description</label>
                        <input type="text" class="form-control" id="landmark" name="landmark" placeholder="Enter nearby landmark or address" required>
                    </div>
