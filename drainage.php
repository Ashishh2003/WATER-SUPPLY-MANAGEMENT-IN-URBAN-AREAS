...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (move_uploaded_file($imageTmpName, $imagePath)) {
        ...
        $sql = $conn->prepare("INSERT INTO drainage (landmark, image_path) VALUES (?, ?)");
...
<head>
    ...
    <title>Drainage Complaint - HydroCity Solutions</title>
    ...
    <section class="complaint-section">
        <div class="container">
            <div class="complaint-card">
                <h2 class="complaint-title">Report Drainage Issue</h2>
                <form action="drainage.php" method="POST" enctype="multipart/form-data">
                    <div class="mb-4">
                        <label for="image" class="form-label">Upload Image of the Issue</label>
