...
// Handle status update if complete button was clicked
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['complaint_id'])) {
    $complaintId = $_POST['complaint_id'];
    $updateSql = "UPDATE drainage SET status = 'completed' WHERE id = ?";
...
$sql = "SELECT id, landmark, image_path, status FROM drainage";
...
<head>
    ...
    <title>Drainage Complaints | HydroCity Solutions</title>
...
<body>
    ...
    <main>
        <h1 class="dashboard-title">Drainage Complaints</h1>
        
        <div class="search-container">
            <input type="text" class="search-input" placeholder="Search by landmark..." id="searchInput">
        ...
        <div class="complaints-container">
            ...
            <table class="complaints-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="action-btn view-btn" onclick="viewComplaint(<?php echo $row['id']; ?>)">
            ...
            <?php else: ?>
                <div class="no-complaints">
                    ...
                    <h4>No drainage complaints found</h4>
                    <p>When complaints are reported, they will appear here</p>
                </div>
            <?php endif; ?>
        </div>
    ...
    <script>
        ...
        document.getElementById('searchInput').addEventListener('keyup', function() {
            ...
            rows.forEach(row => {
                const landmark = row.querySelector('td:nth-child(2)').textContent.toLowerCase();
                if (landmark.includes(searchValue)) {
                    row.style.display = '';
                } else {
        ...
        function viewComplaint(id) {
            // You can implement this to show more details about the complaint
